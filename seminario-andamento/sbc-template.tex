...
Para estes novos testes, utilizar-se-á da ferramenta HiBench \cite{sla,...} que fornece diversas aplicações com características de carga de trabalho distintas. O Hibench é definido como .......
